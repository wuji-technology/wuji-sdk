...
A complete worked example (typed subscription callbacks, with a CMake build) lives in the
repo under [examples/c/wuji_glove/](https://github.com/wuji-technology/wuji-sdk/tree/main/examples/c/wuji_glove).
Point its CMake at the extracted SDK:
